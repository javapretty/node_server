...
Mail.prototype.fetch_mail = function() {
	log_debug('fetch_mail_info, role_id:', this.game_player.player_info.role_id, " role_name:", this.game_player.player_info.role_name);
...
Mail.prototype.pickup_mail = function(msg) {
	log_debug('pickup_mail, role_id:', this.game_player.player_info.role_id, " role_name:", this.game_player.player_info.role_name);
...
Mail.prototype.delete_mail = function(msg) {
	log_debug('delete_mail, role_id:', this.game_player.player_info.role_id, " role_name:", this.game_player.player_info.role_name);
